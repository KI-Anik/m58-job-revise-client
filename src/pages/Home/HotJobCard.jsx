...
const {company_logo,hr_name,status,responsibilities,requirements,company,
        ...
        <div className="card bg-base-100 shadow-sm m-2">
            ...
            <div className="card-body">
                ...
                <div className="card-actions">
                    ...
                    <p className='font-semibold m-2'>Salary: {salaryRange.min}- {salaryRange.max} {salaryRange.currency}</p>
                </div>
